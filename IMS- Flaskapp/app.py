...
app.config['MYSQL_USER'] = '1UJQChBR1k'
app.config['MYSQL_PASSWORD'] = 'VwP1HmKb3s'
app.config['MYSQL_DB'] = '1UJQChBR1k'
mysql = MySQL(app)
app.secret_key = 'a'
...
def cart_checkout():
    if request.method == 'POST':
        ...
        for i in range(count):
            ...
            if resq <= 0:
                prod = cart[i][3]
                sgemail = Mail(from_email = "meghanagoli27@gmail.com",
                ...
                try:
                    sg = SendGridAPIClient('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')
